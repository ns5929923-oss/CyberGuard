    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-1.5 text-sm text-slate-500">Create your security dashboard account</p>
        </div>
        ...
        <div className="rounded-2xl p-8" style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color)' }}>
          ...
          <p className="text-xs text-slate-500 mb-6">Free forever — no credit card required</p>
                ...
                <div className="relative">
                  <input
                    ...
                    style={{
                      ...
                      border: `1px solid ${errors[name] ? 'rgba(239,68,68,0.5)' : 'var(--border-color)'}`,
                      paddingRight: name === 'password' ? '2.5rem' : undefined,
                    }}
                    onFocus={e => { if (!errors[name]) e.target.style.borderColor = 'rgba(59,130,246,0.5)' }}
          ...
          <div className="mt-5 pt-4 border-t border-[var(--border-color)] flex items-center gap-2">
            <LockIcon />
            <p className="text-[11px] text-slate-600">Your password is hashed with bcrypt — we never store plaintext</p>
          </div>
        </div>
